...
std::unique_ptr<runtime::Query> compiled_typer_q1(Database& db, size_t nrThreads, size_t firstTuple, std::unordered_map<std::thread::id, runtime::PartitionedDeque<1024>>&twThreadData) {
